...
CREATE (SM_R:Game{title:"Super Mario Run", price: "9.99", rating: "4" })
...
CREATE (MC4:Game{title:"Modern Combat 4", price: "9.99", rating: "4" })
...
CREATE
	...
	(MOBA)-[:RECOMMENDATION]->(CR),
	(MOBA)-[:RECOMMENDATION]->(BS),
	(MOBA)-[:RECOMMENDATION]->(FFXIV),
	(MOBA)-[:RECOMMENDATION]->(KH),
	(MOBA)-[:RECOMMENDATION]->(Warcraft3),
	(MOBA)-[:RECOMMENDATION]->(Warcraft2),
	(MOBA)-[:RECOMMENDATION]->(NOVAL),
	(MOBA)-[:RECOMMENDATION]->(HOOC),
	(MOBA)-[:RECOMMENDATION]->(FP_A),
	(MOBA)-[:RECOMMENDATION]->(FP_POC),
	(MOBA)-[:RECOMMENDATION]->(FP_FOC),
	(MOBA)-[:RECOMMENDATION]->(Ashen),
	(MOBA)-[:RECOMMENDATION]->(FFVII),
	(MOBA)-[:RECOMMENDATION]->(HU),
	(MMORPG)-[:RECOMMENDATION]->(FFXIV),
	(MMORPG)-[:RECOMMENDATION]->(KH),
	(MMORPG)-[:RECOMMENDATION]->(TES5),
	(MMORPG)-[:RECOMMENDATION]->(GOR),
	(MMORPG)-[:RECOMMENDATION]->(HTL),
	(MMORPG)-[:RECOMMENDATION]->(TUS),
	(MMORPG)-[:RECOMMENDATION]->(TSTU),
	(MMORPG)-[:RECOMMENDATION]->(FFVII),
	(MMORPG)-[:RECOMMENDATION]->(FFIX),
	(MMORPG)-[:RECOMMENDATION]->(FFCC),
	(MMORPG)-[:RECOMMENDATION]->(WOFFM),
	(MMORPG)-[:RECOMMENDATION]->(ME1),
	(MMORPG)-[:RECOMMENDATION]->(ME2),
	(MMORPG)-[:RECOMMENDATION]->(ME3),
	(Fighting)-[:RECOMMENDATION]->(Naruto),
	(Fighting)-[:RECOMMENDATION]->(SSB),
	(Fighting)-[:RECOMMENDATION]->(PSAS),
	(Survival)-[:RECOMMENDATION]->(Journey),
	(Survival)-[:RECOMMENDATION]->(CI),
	(Survival)-[:RECOMMENDATION]->(Dauntless),
	(Survival)-[:RECOMMENDATION]->(MLLR),
	(Survival)-[:RECOMMENDATION]->(BTS),
	(Survival)-[:RECOMMENDATION]->(WWZ),
	(Survival)-[:RECOMMENDATION]->(TSTU),
	(Survival)-[:RECOMMENDATION]->(DQB2),
	(Survival)-[:RECOMMENDATION]->(SOTTR),
	(Survival)-[:RECOMMENDATION]->(TQM),
	(Survival)-[:RECOMMENDATION]->(ME1),
	(Survival)-[:RECOMMENDATION]->(ME2),
	(Survival)-[:RECOMMENDATION]->(ME3),
	(Survival)-[:RECOMMENDATION]->(PID),
	(Survival)-[:RECOMMENDATION]->(Town)
